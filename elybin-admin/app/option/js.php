...
init.push(function () {  
  $('#tooltip a').tooltip();	
  ElybinLocationPicker(<?php echo $in9?>, "app/option/proses.php");
});
</script>  
<!-- ./Javascript -->
<?php
...
<!--
<script src="//cdnjs.cloudflare.com/ajax/libs/x-editable/1.5.1/bootstrap3-editable/js/bootstrap-editable.min.js"></script>W
-->

<script src="min/?b=assets/javascripts&amp;f=select2.min.js,bootstrap-editable.min.js"></script>
